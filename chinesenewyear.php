...
$stmt = $conn->prepare("SELECT id, jenis, harga, gambar FROM cny");
$stmt->execute();
        ...
        <div class="v-card">
            ...
            <div class="v-info">
                ...
                <div class="buttons">
                    ...
                    <a class="info-btn" href="checkout_cny.php?id=<?php echo $row['id']; ?>">Buy</a>
                    <a class="info-btn" href="buy_cny.php?id=<?php echo $row['id']; ?>">Add to Cart</a>
                </div>
