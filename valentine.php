...
$stmt = $conn->prepare("SELECT id, jenis, harga, gambar FROM valentine");
$stmt->execute();
        ...
        <div class="v-card">
            ...
            <div class="v-info">
                ...
                <div class="buttons">
                    ...
                    <a class="info-btn" href="checkout_val.php?id=<?php echo $row['id']; ?>">Buy</a>
                    <a class="info-btn" href="buy_val.php?id=<?php echo $row['id']; ?>">Add to Cart</a>
                </div>
