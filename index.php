    ...
    <body>
        ...
        <section>
            <div class="e-container">
                <div class="e-card">
                    ...
                    <a href="view2.html" target="_blank" class="view-btn">View all</a>
                </div>
                <div class="e-card">
                    <div class="e-imgs">
                    ...
                    <a href="view1.html" target="_blank" class="view-btn">View all</a>
                </div>
                <div class="e-card">
                    <div class="e-imgs">
                        <img src="ram1 (4).jpg">
                    ...
                    <a href="#view" target="_blank" class="view-btn">View all</a>
                </div>
                <div class="e-card">
                    <div class="e-imgs">
                        <img src="cny (1).jpg">
                ...
                <div class="e-card">
                    ...
                    <a href="view.html" target="_blank" class="view-btn">View all</a>
                </div>
        ...
        <section id="bouquet">
            ...
            <div class="bou-container">
                ...
                <div class="bou-card">
                    <img src="sun flower.jpg" style="padding-left: 2rem;">
                    <div class="intro-b">
                        <h3>Premium Flare Floral</h3>
                        <p class="new-price">Rp 550.000.00</p>
                        <div class="bou-button">
                ...
                <div class="bou-card">
                    <img src="green.jpg" style="padding-left: 35px;">
                    <div class="intro-b">
                        <h3>Premium Flare Floral</h3>
                        <p class="new-price">Rp 550.000.00</p>
                        <div class="bou-button">
