...
$stmt = $conn->prepare("SELECT id, jenis, harga, gambar FROM teacher");
$stmt->execute();
        ...
        <div class="v-card">
            ...
            <div class="v-info">
                ...
                <div class="buttons">
                    ...
                    <a class="info-btn" href="checkout_tea.php?id=<?php echo $row['id']; ?>">Buy</a>
                    <a class="info-btn" href="buy_tea.php?id=<?php echo $row['id']; ?>">Add to Cart</a>
                </div>
