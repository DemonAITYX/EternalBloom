...
$stmt = $conn->prepare("SELECT id, jenis, harga, gambar FROM ramadhan ORDER BY id ASC");
$stmt->execute();
        ...
        <div class="product-container">
            ...
            <div class="product-details">
                ...
                <div class="form-section">
                    ...
                    <a class="add-to-cart" href="checkout_ram.php?id=<?php echo $row['id']; ?>&qty=" onclick="this.href += this.parentElement.querySelector('input[type=number]').value;">ADD TO CART</a>
                </div>
            </div>
